...
```{r get data}
df.load_raw_exp1 <- read.csv('../../../data/exp1/RAW_DATA/exp1_data_0414.csv')
...
write.csv(df.ppt, "../../../data/exp1/PROCESSED_DATA/exp1_ppt_0414.csv", row.names = FALSE)
```
...
df.trial <- df.raw_exp1 %>% 
  select(id, age_months, age_years, 
         stim_set, highest_count, knower_level, knower_level_cp_subset,
         trial, magnitude, set_chosen, count, correction_after_prompt, final_count, set_asked, n_bunnies, n_lions) %>%
...
write.csv(df.trial, "../../../data/exp1/PROCESSED_DATA/exp1_trial_0414.csv", row.names = FALSE)
```
