...
```{r get data}
df.ppt_raw <- read.csv('../../../data/exp1/PROCESSED_DATA/exp1_ppt_0414.csv')
df.trial_raw <- read.csv('../../../data/exp1/PROCESSED_DATA/exp1_trial_0414.csv')
```
...
Combining both overt set selection and correct counting.
...
```{r}
fit.base <- glmer(correct_set_chosen_or_correct_count ~ magnitude + age_years + (1|id) + (1|trial_ratio), data = df.trial, family="binomial")
summary(fit.base)
...
fit.cp_age <- glmer(correct_set_chosen_or_correct_count ~ knower_level_cp_subset + magnitude + age_years + (1|id) + (1|trial_ratio), data = df.trial, family="binomial")
summary(fit.cp_age)
...
fit.cp_age_int <- glmer(correct_set_chosen_or_correct_count ~ knower_level_cp_subset * magnitude + age_years + (1|id) + (1|trial_ratio), 
                        data = df.trial %>%
                          mutate(age_years = as.factor(age_years)), 
                        family="binomial")
...
```{r}
fit.base_hc <- glmer(correct_set_chosen_or_correct_count ~ highest_count + magnitude + age_years + (1|id) + (1|trial_ratio), 
                     data = df.trial %>%
...
fit.base_hc_comp <- glmer(correct_set_chosen_or_correct_count ~ magnitude + age_years + (1|id) + (1|trial_ratio), 
                     data = df.trial %>%
                                  filter(!is.na(highest_count)),
                                family="binomial")
...
#----------
# knower level effect is wiped out by age effects
fit.cp_age_hc <- glmer(correct_set_chosen_or_correct_count ~ highest_count + knower_level_cp_subset + magnitude + age_years + (1|id) + (1|trial_ratio),                    data = df.trial %>%
                                  filter(!is.na(highest_count)),
                                family="binomial")
summary(fit.cp_age_hc)
Anova(fit.cp_age_hc, type = 3)

fit.cp_age_hc_comp <- glmer(correct_set_chosen_or_correct_count ~ knower_level_cp_subset + magnitude + age_years + (1|id) + (1|trial_ratio),                    data = df.trial %>%
                                  filter(!is.na(highest_count)),
                                family="binomial")
...
fit.cp_age_int_hc <- glmer(correct_set_chosen_or_correct_count ~ highest_count + knower_level_cp_subset * magnitude + age_years + (1|id) + (1|trial_ratio),                    data = df.trial %>%
                                  filter(!is.na(highest_count)),
                                family="binomial")
summary(fit.cp_age_int_hc)
Anova(fit.cp_age_int_hc, type = 3)

fit.cp_age_int_hc_comp <- glmer(correct_set_chosen_or_correct_count ~ knower_level_cp_subset * magnitude + age_years + (1|id) + (1|trial_ratio), 
                                data = df.trial %>%
                                  filter(!is.na(highest_count)),
                                family="binomial")
